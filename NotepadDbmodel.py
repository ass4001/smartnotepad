...
class DbModel:
    ...
    def close_db_connection(self):
        ...
        if self.conn is not None:
            self.conn.close()
        print("Connection closed successfully from the db")
    ...
    def add_file_to_db(self, file_name, file_path, file_owner, file_pwd):
        ...
        self.cur.execute("insert into mysecurefiles(file_id,file_name,file_path,file_owner, file_pwd) values(:1 ,:2 ,:3 ,:4 ,:5)",
